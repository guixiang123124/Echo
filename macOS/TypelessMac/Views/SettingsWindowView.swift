...
struct AboutSettingsTab: View {
    var body: some View {
        VStack(spacing: 20) {
            ...
            VStack(spacing: 8) {
                Link("Visit Website", destination: URL(string: "https://github.com/guixiang123124/Typeless")!)
                Link("Report an Issue", destination: URL(string: "https://github.com/guixiang123124/Typeless/issues")!)
            }

            Spacer()

            Text("© 2024 Typeless. All rights reserved.")
                .font(.caption)
                .foregroundColor(.secondary)
        }
        .padding()

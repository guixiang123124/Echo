        ...
        List {
            Section {
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    setupStep(number: 4, text: "Select 'Typeless'")
                    setupStep(number: 5, text: "Tap 'Typeless' and enable 'Allow Full Access'")
                    setupStep(number: 6, text: "Switch to Typeless using the globe key")
                }
                .padding(.vertical, 8)
            } header: {
                Text("Setup Steps")

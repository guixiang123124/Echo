...
public final class AppSettings: @unchecked Sendable {
    public static let appGroupIdentifier = "group.com.typeless.shared"
    ...
    private enum Keys {
        static let selectedASRProvider = "typeless.asr.selected"
        static let preferStreaming = "typeless.asr.streaming"
        static let correctionEnabled = "typeless.correction.enabled"
        static let selectedCorrectionProvider = "typeless.correction.selected"
        static let defaultInputMode = "typeless.keyboard.mode"
        static let hapticFeedback = "typeless.keyboard.haptic"
        static let autoCapitalization = "typeless.keyboard.autocap"
        static let pendingTranscription = "typeless.ipc.pending_transcription"
    }
}
